...
class Header extends Component {
  ...
  <div className="header-wrapper d-flex align-items-center justify-content-between px-5">
    ...
    <div className="nav-wrap d-flex align-items-center">
        ...
        <div className="mx-3" onClick={()=>{this.props.history.push('/login/')}}><i className="fa fa-sign-in mr-1" aria-hidden="true" />LOGIN</div>
        <div className="mx-3" onClick={()=>{this.props.history.push('/register/')}}><i className="fa fa-pencil-square-o mr-1" aria-hidden="true" />SIGN UP</div>
