...
export default class AdminSetMarkupPercentage extends Component {
  ...
  render() {
      const { markupFieldsDeduction, onChange, saveEnquiryMarkups } = this.props;
      return (
            <form className="row enqueries-form">
                ...
                <div className="clear col-md-6">
                    <button className="btn btn-class" onClick={(e)=>{e.preventDefault(); saveEnquiryMarkups(); e.preventDefault();}}>Submit</button>
                </div>
            </form>
      )
