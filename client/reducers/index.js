...
import {
  LOGIN_SUCCESS, LOGIN_FAILURE, VERIFY_TOKEN_SUCCESS, VERIFY_TOKEN_FAILURE,
...
import {
  GET_INSPECTOR_PROFILE_SUCCESS, GET_INSPECTOR_PROFILE_FAILURE, GET_INSPECTORS_SUCCESS,
  ...
  UPDATE_INSPECTOR_PROFILE_SUCCESS, UPDATE_INSPECTOR_PROFILE_FAILURE, UPDATE_INSPECTOR_PROFILE
} from '../actions/inspector';

import {
  CREATE_ENQUIRY_SUCCESS, CREATE_ENQUIRY_FAILURE, GET_CUSTOMER_ENQUIRIES_SUCCESS,
  ...
  ACCEPT_REJECT_ENQUIRY_QUOTE_SUCCESS, ACCEPT_REJECT_ENQUIRY_QUOTE_FAILURE
} from '../actions/enquiry';

import {
  CREATE_ORDER_SUCCESS, CREATE_ORDER_FAILURE, GET_USER_ORDERS_SUCCESS, GET_USER_ORDERS_FAILURE,
  GET_ADMIN_ORDERS_SUCCESS, GET_ADMIN_ORDERS_FAILURE
} from '../actions/order';
...
export default function (state = INITIAL_STATE, action) {
  ...
  switch (action.type) {
    case LOCATION_CHANGE:
      return {
        ...state, error: null, loading: false, logout: false, createEnquirySuccess: false, createdEnquiry: null,
    ...
    case ACTION_IN_PROGRESS:// start fetching posts and set loading = true
      return {
        ...state, error: null, loading: true, logout: false, createEnquirySuccess: false, createdEnquiry: null,
        enquiryQuoteUpdated: false, enquiryInspectorMatches: [], inspectorAssignedSuccess: false, currentEnquiry: null,
        quoteAcceptRejectSuccess: false, downloadUrl: null, profileUpdateSuccess: false, contactUsEmailSuccess: false,
        signUpSuccess: false, inspectors: [], setupAccountSuccess: false, verifyEmailSuccess: false, createOrderSuccess: false,
        createdOrder: null, orders: null
    ...
    case INIT_APP_SUCCESS:
      return {
        ...state, ports: action.payload.ports, countries: action.payload.countries,
    ...
    case 'CHANGE_USER_PASSWORD':
      return {
        ...state,
        loading: false,
        userProfile: {...state.userProfile, password: action.payload.confirmPassword}
      }
