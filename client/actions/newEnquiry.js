...
// async actions
export function getAllEnquiries(data){
  return dispatch => makeGetRequest('get','/enquiry/getAllEnquiryForInspector?page=0&size=3&from=2018-01-01&to=2018-07-30&status=ORDERED')
