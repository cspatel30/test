...
import { ENQUIRY_MARKUP } from '../constants/ActionsTypes';
...
export function loginPayload(payload) { return ({ type: ENQUIRY_MARKUP, payload }); }

//async actions or server request from front-end
export function login() { return dispatch => makeRequest('post', '/api/admin/login/')
